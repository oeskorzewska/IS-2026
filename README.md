# IS-2026
# Supplementary Materials for our submission to **Interspeech Conference 2026** titled: "Informativity of high-frequency bands on the place of articulation shift in retroflex sibilants produced by children"
...
- `NE0–NE27` = Noise Energy in consecutive 500 Hz subbands from 2–16 kHz
- `FNE12/FNE23/FNE34` = integrated Fricative Noise Energy between consecutive fricative formant frequency pairs
- `FNER(i,j)` = ratio between the corresponding FNE measures
